...
async function main(){
    ...
    await getSongs("songs/01-Latest")
    ...
    currentSong.addEventListener("timeupdate", ()=>{
        document.querySelector(".songtime").innerHTML = `${sTMS(currentSong.currentTime)} / ${sTMS(currentSong.duration)}`
